...
3. Rejects empty, unexpectedly small, or duplicate datasets.
4. Produces a minified `products.json` and a checksum manifest.
5. Commits the result only after every validation succeeds.
